...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        AdminLink = (TextView) findViewById(R.id.admin_button);
        NotAdminLink = (TextView) findViewById(R.id.not_an_admin);
        loadingBar = new ProgressDialog(this);
        ForgetPassword = findViewById(R.id.forgot_password_button);

        chkBoxRememberMe = (CheckBox) findViewById(R.id.check_box_login);
        Paper.init(this);
